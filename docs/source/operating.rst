[projcet2-cf35] Operating Details
====================================

Generated On: 2024-10-17 17:05:01 UTC
...
.. important::
   ...
   **not be valid if your [projcet2-cf35] container is NOT running**.

.. tip::
   You must have your [projcet2-cf35] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/ateimouri/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/ateimouri/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45787  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='ateimouri'  \-\-env DOCKERUSERNAME='ateimouri1@myseneca.ca'  \-\-env MQTTUSERNAME='ateimouri1@myseneca.ca'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   ateimouri1@myseneca.ca/projcet2-cf35-amd64 (https://hub.docker.com/r/ateimouri1@myseneca.ca/projcet2-cf35-amd64)
...
.. important::
   docker run -d -p 38891:38891 -p 42829:42829 -p 54803:54803 \-\-env TSS=0 \-\-env SOLUTIONNAME=projcet2-cf35 \-\-env SOLUTIONDAG=solution_preprocessing_dag-projcet2-cf35 \-\-env GITUSERNAME=ateimouri  \-\-env GITREPOURL=https://github.com/ateimouri/raspberrypi \-\-env SOLUTIONEXTERNALPORT=38891  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=42829  \-\-env SOLUTIONVIPERVIZPORT=54803 \-\-env DOCKERUSERNAME='ateimouri1@myseneca.ca'  \-\-env EXTERNALPORT=45787 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ateimouri1@myseneca.ca' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  ateimouri1@myseneca.ca/projcet2-cf35-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=54803
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=38891
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - ateimouri1@myseneca.ca/projcet2-cf35-amd64
...
It can be accessed by entering: http://localhost:42829
...
.. important::
   http://localhost:54803/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54803/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:54803/<html file>
...
[projcet2-cf35] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/ateimouri/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/projcet2-cf35
...
.. important::
   https://projcet2-cf35.readthedocs.io
...
.. important::
   solution_preprocessing_dag-projcet2-cf35
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38891, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43831, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38983, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41927, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36281, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37351, HPDEHOST=127.0.1.1, HPDEPORT=42219, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41677

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1036-projcet2-cf35,solution_preprocessing_dag-projcet2-cf35, python-preprocess-160-projcet2-cf35,solution_preprocessing_dag-projcet2-cf35, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
